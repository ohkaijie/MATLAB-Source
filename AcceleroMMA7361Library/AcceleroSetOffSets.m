...
function [offSet0, offSet1, offSet2]=AcceleroSetOffSets(refVoltage,xOffSet,yOffSet,zOffSet)
    if(refVoltage==3.3)
        offSet0= xOffSet*1024/3300;
        offSet1= yOffSet*1024/3300;
        offSet2= zOffSet*1024/3300;
    else
        offSet0= xOffSet*1024/5000;
        offSet1= yOffSet*1024/5000;
        offSet2= zOffSet*1024/5000;
    end
end